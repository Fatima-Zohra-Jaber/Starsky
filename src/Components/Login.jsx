...
export default function Login() {
  ...
  return (
    <div className="flex-grow overflow-y-auto flex justify-center items-center p-4 relative">     
      <div className="relative w-full max-w-md transition-all duration-300 hover:shadow-[0_0_15px_rgba(37,99,235,0.3)]">
        {/* Carte de connexion */}
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-8 shadow-2xl">
          {/* En-tête */}
          <h2 className="text-center text-2xl font-bold text-white mb-2">Connexion</h2>
